...
import it.unisa.scanapp.domain.Category;
import it.unisa.scanapp.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link it.unisa.scanapp.domain.Category}.
 */
@RestController
@RequestMapping("/api")
