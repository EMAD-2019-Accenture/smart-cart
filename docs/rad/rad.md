...
| Nome                   | UC_2 - Proposta prodotti in Promozione                                                                                                                                                                                                                                       |
|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Attori  Partecipanti   | Acquirente                                                                                                                                                                                                                                                                   |
| Flusso  di Eventi      | 1. L' Acquirente invia al sistema il codice di un prodotto.<br>&nbsp; 2. Il sistema ricerca prodotti appartenenti alla stessa categoria,       presenti nello stessa filiale, che sono in promozione o in       prossima scadenza e, se vengono trovati, li propone all'acquirente. |
| Condizioni di Ingresso | L' Acquirente ha effettuato UC_1 correttamente                                                                                                                                                                                                                               |
| Condizioni d'uscita    | L'Acquirente visualizza correttamente le offerte proposte, se ve ne sono.                                                                                                                                                                                                    |
| Flussi alternativi.    | Al punto 2. Il sistema potrebbe rispondere con un messaggio d'errore dovuto a problemi di rete.                                                                                                                                                                      |
| Nome                   | UC_3 - Aggiunta prodotti scansionati al carrello                                                                                                                                                                                                                                       |
|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Attori  Partecipanti   | Acquirente                                                                                                                                                                                                                                                                   |
| Flusso  di Eventi      | 1. L' Acquirente ha scansionato il prodotto e ha ricevuto le informazioni relative al prodotto.<br>&nbsp; 2. Il sistema mostra un pop-up nel quale chiede all'Acquirente se intende aggiungere il prodotto al proprio carrello.<br> 3. L'Acquirente risponde alla domanda del sistema seleziona l'opzione "Si".<br>&nbsp; 4. Il sistema aggiunge il prodotto al carrello dell'Acquirente e aggiorna l'ammontare complessivo del carrello con il prezzo del prodotto appena aggiunto|
| Condizioni di Ingresso | L' Acquirente ha effettuato UC_1 correttamente                                                                                                                                                                                                                               |
| Condizioni d'uscita    | Il sistema aggiunge correttamente il prodotto scansionato al carrello dell'utente aggiornando senza errori l'ammontare complessivo del carrello                                                                                                                                                                                                    |
